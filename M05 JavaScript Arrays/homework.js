...
function arrayContiene(array, elemento) {
   ...
   // Tu código:
   let incluyeElemento = array.includes(elemento);
...
function tablaDelSeis() {
   ...
   let multiplicador = [];
   for(i=0; i<11; i++){
    multiplicador.push(i);
   } let resultadoM = multiplicador.map(x => x*6);
   return resultadoM
